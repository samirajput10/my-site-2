            ...
            <div className="text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
                    ...
                    <div className="flex flex-col items-center space-y-2">
                        ...
                        <p className="mt-2 text-muted-foreground text-center max-w-xs">samiullah is the technical architect behind Dazelle, blending his love for code with a keen eye for user experience to build a seamless platform.</p>
                    </div>
                    {/* Founder 2 */}
                    <div className="flex flex-col items-center space-y-2">
                        <Avatar className="w-32 h-32 mb-2 border-4 border-primary/20 shadow-lg">

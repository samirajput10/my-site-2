      ...
      <div className="container mx-auto px-4">
        <Card className="max-w-4xl mx-auto shadow-xl rounded-2xl overflow-hidden border">
          <CardHeader className="text-center p-8 bg-muted/30">
            ...
            <CardTitle className="text-3xl md:text-4xl font-headline">About StyleFusion</CardTitle>
            ...
            <div className="text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
                    ...
                    <div className="flex flex-col items-center space-y-2">
                        ...
                        <p className="mt-2 text-muted-foreground text-center max-w-xs">Alex is the visionary behind StyleFusion, passionate about curating unique styles and empowering independent designers.</p>
                    </div>
                    {/* Founder 2 */}
                    <div className="flex flex-col items-center space-y-2">
                        <Avatar className="w-32 h-32 mb-2 border-4 border-primary/20 shadow-lg">
                        ...
                        <p className="mt-2 text-muted-foreground text-center max-w-xs">Ben is the technical architect behind StyleFusion, blending his love for code with a keen eye for user experience to build a seamless platform.</p>
                    </div>
                </div>
            </div>
          </CardContent>

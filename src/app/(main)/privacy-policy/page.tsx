        ...
        <Card className="max-w-4xl mx-auto shadow-xl rounded-2xl overflow-hidden border">
          ...
          <CardContent className="p-8 md:p-12">
            <div className="prose dark:prose-invert max-w-none text-foreground/90 leading-relaxed space-y-8">
              <p>
                Welcome to Velbric. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us.
              </p>
              ...
              <section>
                ...
                <p>
                  If you have questions or comments about this policy, you may email us at <a href="mailto:privacy@velbric.com" className="text-primary hover:underline">privacy@velbric.com</a> or by post to:
                </p>

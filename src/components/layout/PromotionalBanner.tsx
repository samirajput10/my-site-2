...
export function PromotionalBanner() {
  ...
  return (
    <div className={cn(
        "relative bg-primary text-primary-foreground text-sm font-medium text-center z-50 transition-all duration-300 ease-in-out overflow-hidden dark:shadow-[0_4px_14px_0_rgba(255,255,255,0.1)]",
